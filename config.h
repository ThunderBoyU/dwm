...
static const int topbar             = 1;        /* 0 means bottom bar */ static const char *fonts[]          = { "rissole:size=8" };
static const char dmenufont[]       = "rissole:size=8";
...
static const char *pausempvcmd[] = {"togglempv", NULL};
static const char *wallcmd[] = {"pickwall", NULL};
